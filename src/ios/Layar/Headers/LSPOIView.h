 ...
 * @param pois The poi objects that will be inserted
 * @param indexes The indexes at which the POI's will be inserted
 */
- (void)model:(LSPOIModel*)model willInsertPOIs:(NSArray*)pois atIndexes:(NSArray*)indexes;
 ...
 * @param pois The poi objects that were removed
 * @param indexes The indexes from which the POI's were removed
 */
- (void)model:(LSPOIModel*)model didRemovePOIs:(NSArray*)pois atIndexes:(NSArray*)indexes;
